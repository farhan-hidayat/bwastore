...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::table('users', function (Blueprint $table) {
            ...
            $table->string('provinces_id')->nullable()->change();
            $table->string('regencies_id')->nullable()->change();
            $table->string('zip_code')->nullable()->change();
            $table->string('country')->nullable()->change();
            $table->string('phone_number')->nullable()->change();
            $table->string('store_name')->nullable()->change();
            $table->integer('store_category_id')->nullable()->change();
    ...
    public function down()
    {
        Schema::table('users', function (Blueprint $table) {
            ...
            $table->string('provinces_id')->nullable(false)->change();
            $table->string('regencies_id')->nullable(false)->change();
            $table->string('zip_code')->nullable(false)->change();
            $table->string('country')->nullable(false)->change();
            $table->string('phone_number')->nullable(false)->change();
            $table->string('store_name')->nullable(false)->change();
            $table->integer('store_category_id')->nullable(false)->change();
